...
public class ReflectionRefractionTests {
    ...
    @Test
    public void testBlurryGlassAdaptive() {
        ...
        ImageWriter imageWriter = new ImageWriter("blurryGlass2-Adaptive", 500, 500);
        camera.setImageWriter(imageWriter) //
                .setRayTracer(new SimpleRayTracer(scene)) //
                .build() //
                .renderImage()
    ...
    @Test
    public void testBlurryGlassSuperSampling() {
        ...
        ImageWriter imageWriter = new ImageWriter("blurryGlass2-SuperSampling", 500, 500);
        camera.setImageWriter(imageWriter) //
                .setRayTracer(new SimpleRayTracer(scene)) //
                .build() //
                .renderImage()

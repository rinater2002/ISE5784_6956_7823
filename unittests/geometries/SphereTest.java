...
class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        // TC1: Ray starts at sphere and goes inside (1 point)
        assertEquals(List.of(new Point(2, 0, 0)),
                sphere.findIntersections(new Ray(new Point(1, -1, 0),
                        new Vector(1, 1, 0))),
                "Ray inside the Sphere");
        // TC2: Ray starts at sphere and goes outside (0 points)
        assertNull(
                sphere.findIntersections(new Ray(new Point(2, 0, 0),
                        new Vector(1, 1, 0))),
        ...
        // TC4: Ray starts at sphere and goes inside (1 point)
        assertEquals(List.of(new Point(1, 1, 0)),
                sphere.findIntersections(new Ray(new Point(1, -1, 0),
                        new Vector(0, 1, 0))),
                "line at the zero point, ray from and crosses sphere");
        // TC5: Ray starts inside (1 point)
        assertEquals(List.of(new Point(1, 1, 0)),
                sphere.findIntersections(new Ray(new Point(1, 0.5, 0),
                        new Vector(0, 1, 0))),
                "line at the zero point, ray from inside sphere");
        // TC6: Ray starts at the center (1 point)
        assertEquals(List.of(new Point(1, 1, 0)),
                sphere.findIntersections(new Ray(new Point(1, 0, 0),
                        new Vector(0, 1, 0))),
